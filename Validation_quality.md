...
19/02/2020
  ...
  - [Vizualisation of the results](#vizualisation-of-the-results)

## Validation of the quality evaluation

This rmarkdown document report the quality evaluation performed on the
pdf of the folder validation set (material and method extracted by the
tool to segment article). The comparison is then plotted.
...
![](Validation_quality_files/figure-gfm/unnamed-chunk-4-1.png)<!-- -->
