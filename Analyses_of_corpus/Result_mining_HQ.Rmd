...
```{r double barplot, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
...
plot_circular_toxicity <- function(result_df, ontology_classification, ontology_nanoparticles, title_circle) {
  ...
  sheet_name<-paste0(title_circle, " point 2")
  print(paste0("data exported to ", sheet_name))
  write.xlsx(data, file = "data.xlsx",sheetName = paste0(title_circle, " point 2"), append = TRUE)
...
```{r graph_point_2_liver, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
plot_circular_toxicity(result_df2, ontology_classification, ontology_nanoparticles, "Liver toxicity")

```


```{r graph_point_2_immune, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
...
```{r graph_part_3, fig.height=10, fig.width=10}
data<-result_df2
...
print(paste0("data exported to graph point 3"))
write.xlsx(data, file = "data.xlsx", sheetName = paste0("graph point 3"), append = TRUE)
...
##Excel part
sheet_name<-paste0("Graph point 4")
print(paste0("data exported to ", sheet_name))
write.xlsx(data, file = "data.xlsx", sheetName = sheet_name, append = TRUE)
...
```{r graph_point_4, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
...
```{r graph_point_4_second_version, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
...
plot_circular_toxicity_per_np <- function(data, new_ontologies, vector_effect, circle_title) {
  ...
  ##Excel part
  sheet_name<-paste0(circle_title, " Graph point 4")
  print(paste0("data exported to ", sheet_name))
  write.xlsx(data, file = "data.xlsx",sheetName = sheet_name, append = TRUE)
...
```{r graph_susanne_presentation, fig.height=10, fig.width=10, dpi=350, dev="jpeg"}
new_ontologies<-unlist(ontology_nanoparticles, use.names = FALSE)
...
##Excel part
sheet_name<-paste0("Graph for susanne's presentation 4")
print(paste0("data exported to ", sheet_name))
write.xlsx(data, file = "data.xlsx",sheetName = sheet_name, append = TRUE)
